  ...
  const handleEdit = (announcement) => {
    ...
    setPublishDate(
      announcement.publish_date
        ? announcement.publish_date.substring(0, 16)
        : "",
    );

    setExpireDate(
      announcement.expire_date ? announcement.expire_date.substring(0, 16) : "",
    );

    setIsActive(Boolean(announcement.is_active));
  };
        ...
        <div>
          {announcements.map((announcement) => (
            <div key={announcement.id}>
              ...
              <p>Publish Date: {announcement.publish_date}</p>

              {announcement.expire_date && (
                <p>Expire Date: {announcement.expire_date}</p>
              )}
